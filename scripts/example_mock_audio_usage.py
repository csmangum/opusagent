#!/usr/bin/env python3
"""
Example: Using Generated Audio Files with LocalRealtimeClient

This script demonstrates how to use the audio files generated by generate_mock_audio.py
with the LocalRealtimeClient for testing and development.
...
async def example_basic_usage():
    """Example of basic LocalRealtimeClient usage with generated audio."""
    print("=== Basic LocalRealtimeClient Usage ===")
...
async def example_websocket_simulation():
    ...
    try:
        ...
        await mock_client._event_handler.send_session_created()
...
async def main():
    ...
    print("LocalRealtimeClient Audio Usage Examples")
    print("=" * 50)
    ...
    print("\nNext steps:")
    print("1. Use LocalRealtimeClient in your tests")
