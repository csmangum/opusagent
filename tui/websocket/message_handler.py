...
class SessionMessageBuilder:
    ...
    def create_session_end(conversation_id: str) -> Dict[str, Any]:
        ...
        return {"type": "session.end", "conversationId": conversation_id}

    @staticmethod
    def create_user_stream_start(
        conversation_id: str, media_format: str = "raw/lpcm16"
    ) -> Dict[str, Any]:
    ...
    @staticmethod
    def create_user_stream_chunk(
        conversation_id: str, audio_chunk: str
    ) -> Dict[str, Any]:
    ...
    def create_user_stream_stop(conversation_id: str) -> Dict[str, Any]:
        ...
        return {"type": "userStream.stop", "conversationId": conversation_id}
