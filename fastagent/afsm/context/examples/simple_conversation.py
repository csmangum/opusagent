"""
Simple example demonstrating the AFSM context management in a conversation flow.
"""
import os
import sys
import time
...
from fastagent.afsm.context import ContextManager, StateContext, ContextItem, ContextCategory, ContextFilter
...
def generate_response(state: str, context: Dict[str, Any]) -> str:
    ...
    In a real AFSM implementation, this would be handled by the state's process method.
    """
    responses = {
