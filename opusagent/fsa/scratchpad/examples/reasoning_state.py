"""
Example of using the scratchpad module with the FSA architecture.
"""
...
from opusagent.fsa.states import FSAState, StateTransition
...
class ReasoningState(FSAState, ScratchpadStateMixin):
    ...
    This combines the FSAState with the ScratchpadStateMixin to create
