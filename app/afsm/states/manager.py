...
logger = logging.getLogger("fastagent.states.manager")

class StateManager:
    """
    Manages the states in an Agentic Finite State Machine and handles transitions
    between them.
    """
    ...
    def __init__(self, initial_state: str):
        ...
        """
        self.states: Dict[str, AFSMState] = {}
        self.current_state_name = initial_state
        self.context = None
    
    def register_state(self, state: AFSMState) -> None:
        """
    ...
    def register_states(self, states: List[AFSMState]) -> None:
        """
    ...
    def get_state(self, state_name: str) -> Optional[AFSMState]:
        """
        Get a state by name.
    ...
    def get_current_state(self) -> Optional[AFSMState]:
        """
