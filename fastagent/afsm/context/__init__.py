"""
Context management module for Agentic Finite State Machines.

This module provides a structured system for managing contextual information within the Agentic 
Finite State Machine (AFSM) architecture. It enables states to maintain, filter, and access 
...
The context module enhances the AFSM architecture by providing explicit memory and information
...
from fastagent.afsm.context.context_item import ContextItem, ContextCategory
