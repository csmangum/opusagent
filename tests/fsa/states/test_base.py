...
class TestFSAState(unittest.TestCase):
    """Tests for the FSAState class"""

    def test_state_initialization(self):
        """Test that a state can be properly initialized"""
        state = FSAState("test_state", "Test state description")
    ...
    def test_state_with_transitions(self):
        ...
        state = FSAState("test_state", "Test description", transitions)
    ...
    def test_scratchpad_operations(self):
        ...
        state = FSAState("test_state", "Test description")
