"""
Primary container for conversation context in Finite State Agents.
"""
from typing import Any, Dict, List, Optional, Set, Union
import json
import time

from opusagent.fsa.context.context_item import ContextItem, ContextCategory, ExpirationPolicy
...
class StateContext:
    ...
    Attributes:
        ...
        current_state: Name of the current state in the FSA
