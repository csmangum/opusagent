...
from fastagent.flows.integration_example import FlowIntegrationExample
...
async def test_telephony_bridge_modification():
    ...
    from fastagent.flows.integration_example import modify_telephony_bridge_for_flows
...
def test_example_usage():
    ...
    from fastagent.flows.integration_example import example_usage
